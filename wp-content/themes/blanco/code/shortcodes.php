...
function etheme_bestsellers_shortcodes($atts, $content=null){
	...
	extract(shortcode_atts(array( 
		'image_width' => 220, 
		'image_height' => 220,
        'title' => __('<a href="product-category/hang-moi/"> Sản phẩm bán chạy </a>', ETHEME_DOMAIN)
	), $atts));  
	global $wpdb;
...
function etheme_featured_shortcodes($atts, $content=null){
	...
	extract(shortcode_atts(array( 
		...
		'image_height' => 220,
		'limit' => 20,
        'title' => __('<a href="product-category/hang-moi/">Sản phẩm nổi bật</a>', ETHEME_DOMAIN)
	), $atts)); 
...
function etheme_new_shortcodes($atts, $content=null){
    ...
    extract(shortcode_atts(array( 
        ...
        'image_height' => 220,
        'limit' => 20,
        'title' => __('<a href="product-category/hang-moi/"> Sản phẩm mới </a>', ETHEME_DOMAIN)
    ), $atts)); 
...
add_shortcode('etheme_new_productbytag', 'etheme_new_productbytag');
function etheme_new_productbytag($atts, $content=null){
	global $wpdb;
	if ( !class_exists('WP_eCommerce') && !class_exists('Woocommerce') ) return false;
	...
	extract(shortcode_atts(array( 
        ...
        'tags' =>'',
		'limit' => 20,
        'title' => __('Sản phẩm theo tag', ETHEME_DOMAIN)
	), $atts)); 
...
?>
    ...
    <div class="one-third">      
        ...
        <form action="<?php the_permalink(); ?>" method="POST" class="form" id="ethemeContactForm">   
            <div class="formField">
                <label for="contactName"><?php _e('Họ và tên : ', ETHEME_DOMAIN); ?> <span class="required">*</span></label>
            ...
            <div class="formField">
                <label for="contactSubject"><?php _e('Tiêu đề :', ETHEME_DOMAIN); ?></label>
                <input type="text" class="textField" name="contactSubject" id="contactSubject" />
                <div class="clear"></div>
            </div>
            <div class="formField">
                <label for="contactMessage"><?php _e('Nội dung tin nhắn : ', ETHEME_DOMAIN); ?> <span class="required">*</span></label>
                <textarea class="textField required-field" name="contactMessage" id="contactMessage" cols="30" rows="10"></textarea>
                <div class="clear"></div>
            </div>
            <div class="formField ">
                <button class="button" name="contactSubmit" type="submit"><span><?php _e('Gửi', ETHEME_DOMAIN); ?></span></button>
