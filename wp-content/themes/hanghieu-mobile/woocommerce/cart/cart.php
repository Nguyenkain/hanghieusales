		...
		<div class="row">
			...
			<div class="col-md-6">
				...
				<div class="buttons-cart">
					...
					<a class="continue" href="<?php echo home_url(); ?>">Tiếp tục mua sắm</a>
					<?php
						if ( sizeof( WC()->cart->cart_contents) > 0 ) :
							echo '<a class="check-out-btn" href="' . WC()->cart->get_checkout_url() . '" title="' . __( 'Checkout' , 'woocommerce') . '">' . __( 'Checkout', 'woocommerce' ) . '</a>';
						endif;
					?>
				</div>
				<!-- /.buttons-cart -->
