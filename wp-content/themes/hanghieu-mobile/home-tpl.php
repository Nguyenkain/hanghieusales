			...
			<div class="container">
				<div class="row">
										...
										<?php if ( $i == 1 ) {
											...
											<div class="left-widget">
												...
												<div class="info">
													...
													<p><i class="fa fa-calendar"></i>&nbsp;<?php the_time( 'd m Y' ); ?>
													</p>
												</div>
											</div>
											<?php
					...
					<div class="col-md-4">
						<div class="box">
							...
							<?php if ( $noibat->have_posts() ): ?>
								<div class="content-blog">
									<?php $j = 1;
									while ( $noibat->have_posts() ):$noibat->the_post(); ?>
										<?php if ( $j == 1 ) {
											?>
					...
					<div class="col-md-2 content-ads">
						<a href="#">
							<img class="img-responsive" src="<?php echo get_template_directory_uri(); ?>/images/ads.png"
							     alt="">
						</a>
					</div>
				</div>
