...
<div class="cart-popup">
    <?php if(wpsc_cart_item_count() > 0): ?>
        ...
        <form action='' method='post' class='wpsc_empty_the_cart fl-l'>
    		...
    		<a href="<?php echo htmlentities(add_query_arg('wpsc_ajax_action', 'empty_cart', remove_query_arg('ajax')), ENT_QUOTES, 'UTF-8'); ?>" class="button emptycart" title="<?php _e('Empty Cart', ETHEME_DOMAIN); ?>"><span><?php _e('Empty Cart', ETHEME_DOMAIN); ?></span></a>
        </form>
