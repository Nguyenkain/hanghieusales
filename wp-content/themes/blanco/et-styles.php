...
<style type="text/css">
    ...
    <?php echo jsString($selectors['google_font']); ?>               { font-family: Arial; <?php //echo (etheme_get_option('google_font') && etheme_get_option('google_font') != '') ? $font_name : 'Georgia' ?>; }
...
<script type="text/javascript">
    ...
    var successfullyAdded2 = 'aaaa<?php _e('was successfully added to your shopping cart.',ETHEME_DOMAIN) ?><div class="clear"><a class="button cont-shop"><span><?php _e('Continue Shopping',ETHEME_DOMAIN) ?></span></a><a href="'+cartHref+'" class="button fl-r"><span><?php _e('Checkout',ETHEME_DOMAIN) ?></span></a></div>';
