...
class Etheme_Subcategories_Widget extends WP_Widget {
    ...
    function Etheme_Subcategories_Widget() {
        ...
        $this->WP_Widget('etheme-subcategories', '8theme - '.__('Subcategories List', ETHEME_DOMAIN), $widget_ops, $control_ops);
    }
...
class Etheme_Twitter_Widget extends WP_Widget {
	function Etheme_Twitter_Widget() {
		...
		$this->WP_Widget( 'etheme-twitter', '8theme - '.__('Twitter Feed', ETHEME_DOMAIN), $widget_ops, $control_ops );
	}
	function widget( $args, $instance ) {
		extract( $args );
		$title = apply_filters('widget_title', $instance['title'] );
...
class Etheme_Recent_Posts_Widget extends WP_Widget {
    ...
    function Etheme_Recent_Posts_Widget() {
        ...
        $this->WP_Widget('etheme-recent-posts', '8theme - '.__('Recent Posts'), $widget_ops);
