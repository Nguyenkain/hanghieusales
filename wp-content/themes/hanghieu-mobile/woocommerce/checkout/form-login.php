		...
		<div class="row">
			...
			<div class="col-md-5">
				<form method="post" action="<?php echo esc_url( $get_checkout_url ); ?>" class="login form">
					...
					<div class="form-group">
						...
						<input type="text" name="username" id="username" class=" input-text form-control"
						       placeholder="Enter email" value="<?php if ( ! empty( $_POST['username'] ) ) {
					...
					<p class="form-row">
						...
						<input type="submit" class="button btn btn-black" name="login"
						       value="<?php _e( 'Login', 'woocommerce' ); ?>"/>
			...
			<div class="col-md-5">
				<form method="post" class="register form">
					...
					<div class="fb-login">
						<a href="#"><img src="<?php echo get_template_directory_uri(); ?>/images/fb-login.png"
						                 alt=""></a>
					</div>
					...
					<p class="form-row">
						...
						<input type="submit" class="button btn btn-black" name="register"
