...
<table class="cart checkout_cart" cellspacing="0" style="margin-bottom: 20px;">
	<tr>
		<th class="product-thumbnail cart_del_column">&nbsp;</th>
		<th class="product-name"><?php _e('Sản Phẩm', ETHEME_DOMAIN); ?></th>
		<th class="product-price cart_del_column"><?php _e('Giá', ETHEME_DOMAIN); ?></th>
		<th class="product-quantity"><?php _e('Số Lượng', ETHEME_DOMAIN); ?></th>
		<th class="product-subtotal"><?php _e('Tổng', ETHEME_DOMAIN); ?></th>
...
font-weight: bold;
margin: 0px 10px;">MÃ GIẢM GIÁ:</div>
					<label for="coupon_code"><?php _e('Coupon', ETHEME_DOMAIN); ?>:</label><input name="coupon_code" class="input-text" id="coupon_code" value="" /> <input type="submit" class="button" name="apply_coupon" value="<?php _e('Kích hoạt', ETHEME_DOMAIN); ?>" />
			...
			<a href="http://hanghieusales.com/shop"> <input class="button" name="shop1" value="TIẾP TỤC MUA SẮM" /> </a>

			<input type="submit" class="button" name="update_cart" value="<?php _e('Cập Nhật Giảm Giá', ETHEME_DOMAIN); ?>" /> 
